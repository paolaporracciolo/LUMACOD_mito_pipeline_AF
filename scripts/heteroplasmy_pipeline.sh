...
# 1_reads_input.sh
# =========> nohup bash 1_reads_input.sh > 1_reads_input.log & 
# STATUS : WORKED with CTRL as well

# 2_A_B_h5ad_input.py
# =========> nohup python 2_A_B_h5ad_input.py > 2_A_B_h5ad_input.log &
# STATUS : WORKED with CTRL as well

# 2_C_D_bam_extraction.sh
# =========> nohup bash 2_C_D_bam_extraction.sh > 2_C_D_bam_extraction.log &
# STATUS : WORKED with CTRL as well

# 2_E_rename_files_celltype_barcode.sh
# =========> nohup bash 2_E_rename_files_celltype_barcode.sh > 2_E_rename_files_celltype_barcode.log &
# STATUS : WORKED with CTRL as well

# 3_stats.sh
# =========> nohup bash 3_stats.sh > 3_stats.log &
# STATUS : WORKED with CTRL as well